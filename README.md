...
## ▶️ Pasos para Ejecutar el Trabajo
...
3. Ejecutar el comando de consola de SQL Server llamado ["sqlcmd"](TP-Gestion-de-Datos/Scripts/cmd.txt)

ℹ️ **Aclaración sobre autenticación:** Al ejecutar sqlcmd, se deben especificar los parámetros:
...
Primero se debe crear el Modelo Operativo corriendo el script
...
✅ Listo ya podemos hacer consultas libremente sobre el modelo OLTP y el OLAP
